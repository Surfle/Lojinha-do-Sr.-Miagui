...
let tudo = ""
for (item of ITENS_LOJA) {

    loja.innerHTML = "<div>"+"<img src="+item.url_img+">" +
                    "<h1>"+ item.nome +"</h1>" + 
                    "<preco>" + "<p id='p1'>Preço: " + "</p>" + "<p> R$ "+item.preco + "</p>" + "</preco>" +
                    "<descricao>" + "<p id='p1'>Descrição: " + "</p>" + "<p> "+item.descricao + "</p>" + "</descricao>" + "</div>"
    tudo = tudo + loja.innerHTML
}
loja.innerHTML = tudo
